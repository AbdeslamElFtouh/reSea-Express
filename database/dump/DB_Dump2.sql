...
(
    ...
    'Ambra della Costa',
    'ambra-della-costa',
    'Questo occhiale reinterpreta una silhouette dal design contemporaneo e pulito attraverso un profondo valore etico. La montatura semitrasparente è interamente realizzata dando una seconda vita ai materiali plastici di scarto e ai rifiuti recuperati dal mare. Grazie a un attento processo di rigenerazione, la plastica acquista una finitura cristallina e luminosa che cattura la luce, dimostrando come gli scarti marini possano trasformarsi in un accessorio moda esclusivo, elegante e rispettoso del nostro pianeta.',
    124.90,
    '2026-05-11',
    1.85,
    'ambra-della-costa.jpg'
 ),
 (
    'Cordoncino Gavitello',
    'cordoncino-gavitello',
    'Questo accessorio unisce un design contemporaneo, sportivo e minimale a un profondo valore etico volto alla pulizia dei mari. Il cordoncino regolabile è interamente realizzato tramite il riciclo e la valorizzazione di scarti plastici e vecchie cime da pesca recuperate dalle acque oceaniche. Grazie a questo virtuoso processo di rigenerazione dei materiali, i rifiuti vengono trasformati in un elemento funzionale, resistente e ricco di stile, pensato per completare la tua scelta ecologica e proteggere i tuoi occhiali in ogni avventura.',
    19.90,
    '2026-04-08',
    0.45,
    'cordoncino-gavitello.jpg'
),
(
    'Cordoncino Ancora',
    'cordoncino-ancora',
    'Questo cordoncino intrecciato combina un design contemporaneo di ispirazione nautica con un profondo valore etico orientato alla rigenerazione dei materiali. Creato interamente attraverso la valorizzazione degli scarti e il riciclo di cime e plastiche recuperate dai fondali marini, l''accessorio si presenta robusto, funzionale e curato nei minimi dettagli. Una scelta d''avanguardia che trasforma i rifiuti oceanici in un simbolo di stile e impegno ecologico.',
    24.90,
    '2026-05-22',
    0.55,
    'cordoncino-ancora.jpg'
    ),
    (
    'Cordoncino Salvagente',
    'cordoncino-salvagente',
    'Questo cordoncino tecnico unisce un design contemporaneo, dinamico e fortemente legato al mondo nautico, con un profondo valore etico volto alla protezione dell''ambiente marino. L''accessorio regolabile è realizzato interamente attraverso la rigenerazione dei materiali e la valorizzazione degli scarti plastici e delle vecchie cime da pesca recuperate dai mari. Un dettaglio di stile resistente e funzionale che trasforma la materia riciclata in un vero e proprio manifesto di sostenibilità e amore per gli oceani.',
    22.90,
    '2026-06-03',
    0.50,
    'cordoncino-salvagente.jpg'
    ),
    (
    'Cordoncino Abisso',
    'cordoncino-abisso',
    'Questo cordoncino intrecciato combina un design contemporaneo di chiara ispirazione nautica con un profondo valore etico incentrato sulla pulizia dei nostri oceani. L''accessorio è interamente realizzato valorizzando gli scarti e rigenerando le vecchie cime da pesca e le plastiche recuperate direttamente dalle acque marine. Robusto, flessibile e rifinito con cura, si adatta perfettamente a ogni montatura, trasformando la materia riciclata in un dettaglio di stile consapevole e funzionale.',
    21.90,
    '2026-04-27',
    0.48,
    'cordoncino-abisso.jpg'
    ),
 (
   'Cordoncino Veliero',
    'cordoncino-veliero',
    'Questo cordoncino per occhiali reinterpreta lo stile nautico classico attraverso un design contemporaneo e sofisticato, arricchito da eleganti dettagli metallici. Il prodotto è guidato da un profondo valore etico: l''intero filato è ottenuto dal recupero, dalla valorizzazione degli scarti e dalla rigenerazione di reti da pesca e materiali plastici abbandonati in mare. Un accessorio funzionale e di carattere, perfetto per chi desidera coniugare l''eleganza a bordo o nella vita quotidiana con una scelta di consumo responsabile e attenta alla salute degli oceani.',
    29.90,
    '2026-05-30',
    0.60,
    'cordoncino-veliero.jpg'
 ),
(
 'Custodia Corallo',
    'custodia-corallo',
    'Questa custodia per occhiali unisce un design contemporaneo, minimale e geometrico a un profondo valore etico orientato alla sostenibilità. Realizzata interamente attraverso la rigenerazione dei materiali e la valorizzazione degli scarti flessibili recuperati o derivati dalla pulizia dei mari, offre una protezione ottimale ed elegante per i tuoi occhiali. Una scelta d''avanguardia che trasforma la materia riciclata in un accessorio piacevole al tatto, funzionale e rispettoso dell''ecosistema marino.',
    34.90,
    '2026-06-07',
    0.80,
    'custodia-corallo.jpg'
),
(
    'Custodia Abisso',
    'custodia-abisso',
    'Questa custodia per occhiali si distingue per un design contemporaneo dalle linee pulite, essenziali ed eleganti. Sviluppata secondo un profondo valore etico, la sua struttura è interamente realizzata attraverso la rigenerazione dei materiali e la valorizzazione degli scarti flessibili recuperati dagli ecosistemi marini. Un accessorio sofisticato e piacevole al tatto che offre una protezione impeccabile, trasformando la materia riciclata in un concreto simbolo di responsabilità ambientale e rispetto per l''oceano.',
    39.90,
    '2026-05-18',
    0.95,
    'custodia-abisso.jpg'
...
(
    'Custodia Alga',
    'custodia-alga',
    'Questa custodia per occhiali reinterpreta la funzionalità quotidiana attraverso un design contemporaneo, geometrico ed essenziale. Il prodotto è mosso da un profondo valore etico incentrato sulla rigenerazione dei materiali: la sua struttura semitrasparente e texturizzata prende vita grazie alla valorizzazione di scarti plastici e polimeri recuperati dai fondali marini. Un accessorio leggero e protettivo che dimostra come l''economia circolare possa trasformare i rifiuti in un elemento di stile d''avanguardia e di rispetto per la natura.',
    36.90,
    '2026-06-11',
    0.85,
    'custodia-alga.jpg'
...
(
    'Custodia Fondale',
    'custodia-fondale',
    'Questa custodia per occhiali unisce un design contemporaneo dalle linee pulite e geometriche a un profondo valore etico di rigenerazione dei materiali. Realizzata interamente attraverso il recupero e la valorizzazione degli scarti plastici e dei polimeri flessibili sottratti ai nostri mari, offre una protezione ottimale con un''elegante finitura opaca e testurizzata. Un accessorio sofisticato ed ecosostenibile che testimonia una rinascita della materia nel pieno rispetto dell''ambiente marino.',
    37.90,
    '2026-05-25',
    0.90,
    'custodia-fondale.jpg'
),
(
    'Custodia Arenile',
    'custodia-arenile',
    'Questa custodia per occhiali reinterpreta la cura dei tuoi accessori attraverso un design contemporaneo, geometrico ed essenziale. Il progetto è guidato da un profondo valore etico basato sulla rigenerazione dei materiali: la sua struttura semitrasparente e puntinata prende vita grazie alla valorizzazione di scarti plastici e polimeri riciclati recuperati dagli ambienti marini. Un accessorio protettivo, leggero e dal look naturale, che dimostra come l''economia circolare possa trasformare i rifiuti in un elemento di stile d''avanguardia.',
    35.90,
    '2026-06-14',
    0.82,
    'custodia-arenile.jpg'
);
...
(
'sara.esposito@email.com',
'Via Dante 21, Bologna',
'Via Dante 21, Bologna',
144.90,
'2026-06-17',
'Sara Esposito',
...
(
'alessandro.russo@email.com',
'Via Mazzini 67, Firenze',
'Via Mazzini 67, Firenze',
154.90,
'2026-06-18',
'Alessandro Russo',
...
(
'francesca.gallo@email.com',
'Piazza Duomo 5, Palermo',
'Piazza Duomo 5, Palermo',
239.80,
'2026-06-18',
'Francesca Gallo',
...
(
'davide.ferrari@email.com',
'Via Manzoni 103, Genova',
'Via Manzoni 103, Genova',
119.90,
'2026-06-19',
'Davide Ferrari',
...
(
'chiara.conti@email.com',
'Via Veneto 17, Verona',
'Via Veneto 17, Verona',
149.90,
'2026-06-19',
'Chiara Conti',
...
(
'elena.marino@email.com',
'Via Cavour 34, Catania',
'Via Cavour 34, Catania',
159.90,
'2026-06-20',
'Elena Marino',
